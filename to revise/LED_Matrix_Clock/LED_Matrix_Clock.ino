...
extern uint8_t num1[8];
extern uint8_t num2[8];
extern uint8_t num3[8];
extern uint8_t num4[8];
...
void printNumber(LedControl lc, uint8_t number)
{
  ...
  {
    lc.setRow(0, 0, 0b00011011);
    lc.setRow(0, 1, 0b00110011);
    lc.setRow(0, 2, 0b01100011);
    lc.setRow(0, 3, 0b11000011);
    lc.setRow(0, 4, 0b11111111);
    lc.setRow(0, 5, 0b01111111);
    lc.setRow(0, 6, 0b00000011);
    lc.setRow(0, 7, 0b00000011);
  }
  else if (number == '5')
  {
    lc.setRow(0, 0, 0b00111110);
